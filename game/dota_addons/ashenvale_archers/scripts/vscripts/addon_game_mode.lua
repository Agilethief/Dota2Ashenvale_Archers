...
--[[
  ...
  --PrecacheUnitByNameAsync( "npc_dota_hero_mirana", function( precache ) self._precacheMirana = precache end )
  
  -- Precache all the particles
  --PrecacheResource( "particle", "particles/basicexplosivearrow.vpcf", context )  -- This should be the heavy arrow
